SELECT
    ...
    ROUND(soil_moisture_0_to_7cm_mean::FLOAT,2) AS "0_to_7cm_mean_soil_moisture",
    ROUND(soil_temperature_0_to_7cm_mean::FLOAT,2) AS "0_to_7cm_mean_soil_temp",
    ...
    ROUND(winddirection_10m_dominant::FLOAT,1) AS dominant_wind_direction,
